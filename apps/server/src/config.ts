import { TOKEN_MAINNET_REF_BY_KEY } from "@auto/api/token-dex-reference";
...
export const TOKENS = {
	WETH: {
		...
		decimals: 18,
		BASE_MAINNET_ADDRESS: TOKEN_MAINNET_REF_BY_KEY.WETH,
	},
	USDC: {
		symbol: "USDC",
		address: "0x036CbD53842c5426634e7929541eC2318f3dCF7e",
		decimals: 6,
		BASE_MAINNET_ADDRESS: TOKEN_MAINNET_REF_BY_KEY.USDC,
		BASE_SEPOLIA_POOL: {
	...
	RISE: {
		...
		decimals: 18,
		BASE_MAINNET_ADDRESS: TOKEN_MAINNET_REF_BY_KEY.RISE,
		BASE_SEPOLIA_POOL: {
